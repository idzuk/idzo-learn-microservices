package ua.idzo.song.web.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleConflict(ConflictRuntimeException ex) {
        Map<String, String> body = getErrorResponseBody(ex.getMessage(), HttpStatus.CONFLICT);
    ...
    public ResponseEntity<Map<String, Object>> handleValidationErrors(MethodArgumentNotValidException ex) {
        ...
        Map<String, Object> body = getDetailedErrorResponseBody("Validation error", HttpStatus.BAD_REQUEST, details);
        return new ResponseEntity<>(body, HttpStatus.BAD_REQUEST);
    }
